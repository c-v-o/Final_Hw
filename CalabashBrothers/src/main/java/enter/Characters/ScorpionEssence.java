...
public class ScorpionEssence extends Character {
    public ScorpionEssence(int x1, int y1,int n, int runturn, Positions positions, AllCharacters.EndFlag endflag) {
        super(x1, y1,n, runturn,positions,endflag);
        this.setProperties("蝎子精", "妖精", "image/蝎子精.png", "image/妖精尸体.png");
    }
